...
{
    /// <summary>
    /// Provides a factory for creating instances of <see cref="DataProtectionKeysDbContext"/> during design time.
    ...
    /// </remarks>
    public class DataProtectionKeysDbContextFactory : PostgreSQLDesignTimeDbContextFactory<DataProtectionKeysDbContext>
    {
    }
